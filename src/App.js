...
function App() {
	...
	return (
		<div className="app">
			<ui5-shellbar primary-title="UI5 Web Components React Sample Application" show-notifications notifications-count="2">
			...
			<section className="app-content">
				<div className="create-todo-wrapper">
					...
					<ui5-button class="add-todo-element-width" ref={addButton} design="Emphasized">
						Add Todo
					</ui5-button>
				</div>
				...
				<div className="list-todos-wrapper">
					...
					<ui5-panel header-text="Completed Tasks" collapsed={!todos.filter((todo) => todo.done).length || undefined} class="list-todos-panel">
			...
			<ui5-popover id="theme-settings-popover" class="app-bar-theming-popover" placement-type="Bottom" horizontal-align="Right" header-text="Theme">
